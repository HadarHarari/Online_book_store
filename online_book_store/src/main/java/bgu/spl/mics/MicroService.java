...
public abstract class MicroService implements Runnable {
    ...
    private ConcurrentHashMap <Class, Callback> callback_type;
    private Message currMsg;

    private static MessageBusImpl message_bus = null;
    ...
    public MicroService(String name)
    {
        ...
        callback_type = new ConcurrentHashMap<>();
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback)
    {
        ...
        callback_type.putIfAbsent(type , callback);
    }
    ...
    public final void run() {
        ...
        while (!terminated)
        {
            currMsg = null;
            try {
                currMsg = message_bus.awaitMessage(this);
            } catch (InterruptedException e) {
                e.printStackTrace();
            }
            callback_type.get(currMsg.getClass()).call(currMsg);
        }
